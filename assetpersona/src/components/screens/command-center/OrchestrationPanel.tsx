...
interface Props {
  waves: WaveEntry[];
  accent: string; accentSoft: string; txtMuted: string; txtHeadline: string;
}

export function OrchestrationPanel({ waves, accent, accentSoft, txtMuted, txtHeadline }: Props) {
  return (
