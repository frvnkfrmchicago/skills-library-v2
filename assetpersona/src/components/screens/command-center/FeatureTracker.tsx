...
interface Props {
  ...
  txtMuted: string; txtHeadline: string; hairline: string;
}

export function FeatureTracker({ features, clones, onAdd, onDelete, onSetStatus, txtMuted, txtHeadline, hairline }: Props) {
