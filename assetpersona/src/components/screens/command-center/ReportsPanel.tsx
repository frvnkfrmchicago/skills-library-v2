...
import { typeScale, fontWeight, spacing } from '@/lib/design-tokens';
...
interface Props {
  ...
  accent: string; txtMuted: string; txtHeadline: string;
}

export function ReportsPanel({ reports, onGenerate, accent, txtMuted, txtHeadline }: Props) {
