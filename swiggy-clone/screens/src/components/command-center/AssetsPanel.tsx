...
import { Image, Film, Music, FileText, FolderOpen, RefreshCw } from 'lucide-react';
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: spacing.md, marginTop: spacing.md }}>
          ...
          <div style={{ marginLeft: 'auto' }}>
            <Button label={loading ? 'Refreshing…' : 'Refresh'} size="sm" variant="secondary" onClick={loadAssets} icon={RefreshCw} />
          </div>
        </div>
      </div>
