---
name: creative-motion-librarian
description: >
  Alias wrapper for the Creative Motion & Spatial UI Librarian persona. Use when the user explicitly names
  this librarian or asks to activate it.
---

# Creative Motion & Spatial UI Librarian

This is a native skill alias for the librarian persona source file:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/creative-motion-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/creative-motion-design/SKILL.md
