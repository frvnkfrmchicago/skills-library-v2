...
def main():
    ...
    output_file = "/Users/franklawrencejr./Downloads/skills-library-v2 2/tools_cookies_profile15.json"
    with open(output_file, "w") as f:
        json.dump({"cookies": formatted_cookies}, f, indent=2)
        
    print(f"\n[SUCCESS] Decrypted and saved cookies to: {output_file}")
    print("You can now SCP this file to your VM for TwoFace to use.")
