---
name: implementation-librarian
description: >
  Alias wrapper for the Implementation Librarian persona. Use when the user explicitly names
...
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/implementation-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/implementation-guiding/SKILL.md
