...
description: >
  Alias wrapper for the Backend Librarian persona. Use when the user explicitly names
...
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/backend-librarian.md
