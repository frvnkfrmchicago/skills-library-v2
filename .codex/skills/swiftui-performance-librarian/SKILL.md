...
description: >
  Alias wrapper for the SwiftUI Performance Librarian persona. Use when the user
  explicitly names this librarian or asks to activate it.
---

# SwiftUI Performance Librarian

This is a native skill alias for the librarian persona source file:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/swiftui-performance-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.agents/skills/swiftui-performance-auditing/SKILL.md
