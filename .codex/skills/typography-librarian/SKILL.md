---
name: typography-librarian
description: >
  Alias wrapper for the Typography Librarian persona. Use when the user explicitly names
  this librarian or asks to activate it.
---

# Typography Librarian

This is a native skill alias for the librarian persona source file:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/typography-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/typography-enforcing/SKILL.md
