...
description: >
  Alias wrapper for the Mobbin Librarian persona. Use when the user explicitly names
...
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/mobbin-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/pattern-referencing/SKILL.md
