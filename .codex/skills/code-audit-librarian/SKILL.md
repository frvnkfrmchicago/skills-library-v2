---
name: code-audit-librarian
description: >
  Alias wrapper for the Code Audit Librarian persona. Use when the user explicitly names
...
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/code-audit-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/code-auditing/SKILL.md
