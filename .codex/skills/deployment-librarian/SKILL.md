...
description: >
  Alias wrapper for the Deployment Librarian persona. Use when the user explicitly names
...
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/deployment-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/deploying/SKILL.md
