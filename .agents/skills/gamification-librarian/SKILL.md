---
name: gamification-librarian
description: >
  Alias wrapper for the Gamification Librarian persona. Use when the user explicitly names
  this librarian or asks to activate it.
---

# Gamification Librarian

This is a native skill alias for the librarian persona source file:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/librarians/gamification-librarian.md

## Base workflow

Use the operational workflow in this native skill:
- /Users/franklawrencejr./Downloads/skills-library-v2 2/.codex/skills/gamification-design/SKILL.md
